  ...
  template <typename Dtype>
    ...
    class SmoothL1LossLayer : public LossLayer<Dtype> {
     public:
      ...
      virtual inline LayerParameter_LayerType type()
        const { return LayerParameter_LayerType_SMOOTH_L1_LOSS;}
   ...
   template <typename Dtype>
      class SoftmaxWithSphereLossLayer : public LossLayer<Dtype> {
        public:
          ...
          virtual inline LayerParameter_LayerType type() const {
            return LayerParameter_LayerType_SOFTMAX_WITH_SPHERE_LOSS;
          }
          virtual inline int ExactNumBottomBlobs() const { return -1; }
          virtual inline int MinBottomBlobs() const { return 2; }
          virtual inline int MaxBottomBlobs() const { return 3; }
    ...
    template <typename Dtype>
      class AccuracySphereLayer : public Layer<Dtype> {
        public:
          ...
          virtual inline LayerParameter_LayerType type() const {
            return LayerParameter_LayerType_ACCURACY_SPHERE;
          }
