...
_LAYERPARAMETER_LAYERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WELL_LOSS', index=39, number=39,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HADAMARD_PRODUCT', index=40, number=40,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBTRACTION', index=41, number=41,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='L1_LOSS', index=42, number=42,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PERIODIC_LOSS', index=43, number=43,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUANT_ACCURACY', index=44, number=44,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LABEL_SPLIT', index=45, number=45,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MIXED_PRED', index=46, number=46,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMBINE_LOSS', index=47, number=47,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SOFTMAX_WITH_VIEW_LOSS', index=48, number=48,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SOFTMAX_POS_NEG_LOSS', index=49, number=49,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ACCURACY_VIEW', index=50, number=50,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DET_VIEW_SPLIT', index=51, number=51,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TRIPLE_VIEW_SPLIT', index=52, number=52,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_COMBINELOSSPARAMETER_NORM = _descriptor.EnumDescriptor(
  name='Norm',
  full_name='caffe.CombineLossParameter.Norm',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_COMBINELOSSPARAMETER_NORM)
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='well_loss_param', full_name='caffe.LayerParameter.well_loss_param', index=40,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hadamard_product_param', full_name='caffe.LayerParameter.hadamard_product_param', index=41,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='subtraction_param', full_name='caffe.LayerParameter.subtraction_param', index=42,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='l1_loss_param', full_name='caffe.LayerParameter.l1_loss_param', index=43,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='periodic_loss_param', full_name='caffe.LayerParameter.periodic_loss_param', index=44,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quant_accuracy_param', full_name='caffe.LayerParameter.quant_accuracy_param', index=45,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_split_param', full_name='caffe.LayerParameter.label_split_param', index=46,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mixed_pred_param', full_name='caffe.LayerParameter.mixed_pred_param', index=47,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='combine_loss_param', full_name='caffe.LayerParameter.combine_loss_param', index=48,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='softmax_with_view_loss_param', full_name='caffe.LayerParameter.softmax_with_view_loss_param', index=49,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='softmax_pos_neg_loss_param', full_name='caffe.LayerParameter.softmax_pos_neg_loss_param', index=50,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='accuracy_view_param', full_name='caffe.LayerParameter.accuracy_view_param', index=51,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='transform_param', full_name='caffe.LayerParameter.transform_param', index=52,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='layer', full_name='caffe.LayerParameter.layer', index=53,
...
_WELLLOSSPARAMETER = _descriptor.Descriptor(
  name='WellLossParameter',
  full_name='caffe.WellLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='slope', full_name='caffe.WellLossParameter.slope', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='low_bound', full_name='caffe.WellLossParameter.low_bound', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='high_bound', full_name='caffe.WellLossParameter.high_bound', index=2,
      number=3, type=2, cpp_type=6, label=1,
...
_HADAMARDPRODUCTPARAMETER = _descriptor.Descriptor(
  name='HadamardProductParameter',
  full_name='caffe.HadamardProductParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weight_filler', full_name='caffe.HadamardProductParameter.weight_filler', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SUBTRACTIONPARAMETER = _descriptor.Descriptor(
  name='SubtractionParameter',
  full_name='caffe.SubtractionParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mean_file', full_name='caffe.SubtractionParameter.mean_file', index=0,
...
_PERIODICLOSSPARAMETER = _descriptor.Descriptor(
  name='PeriodicLossParameter',
  full_name='caffe.PeriodicLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='period', full_name='caffe.PeriodicLossParameter.period', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_max', full_name='caffe.PeriodicLossParameter.label_max', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=360,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUANTACCURACYPARAMETER = _descriptor.Descriptor(
  name='QuantAccuracyParameter',
  full_name='caffe.QuantAccuracyParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='in_period', full_name='caffe.QuantAccuracyParameter.in_period', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=360,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='out_num', full_name='caffe.QuantAccuracyParameter.out_num', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=16,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='label_max', full_name='caffe.QuantAccuracyParameter.label_max', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=360,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LABELSPLITPARAMETER = _descriptor.Descriptor(
  name='LabelSplitParameter',
  full_name='caffe.LabelSplitParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='period', full_name='caffe.LabelSplitParameter.period', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=360,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='split_num', full_name='caffe.LabelSplitParameter.split_num', index=1,
      number=2, type=5, cpp_type=1, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_max', full_name='caffe.LabelSplitParameter.label_max', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=360,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MIXEDPREDPARAMETER = _descriptor.Descriptor(
  name='MixedPredParameter',
  full_name='caffe.MixedPredParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='period', full_name='caffe.MixedPredParameter.period', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=360,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='split_num', full_name='caffe.MixedPredParameter.split_num', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=2,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COMBINELOSSPARAMETER = _descriptor.Descriptor(
  name='CombineLossParameter',
  full_name='caffe.CombineLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='period', full_name='caffe.CombineLossParameter.period', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=360,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='split_num', full_name='caffe.CombineLossParameter.split_num', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=2,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='norm', full_name='caffe.CombineLossParameter.norm', index=2,
...
_SOFTMAXWITHVIEWLOSSPARAMETER = _descriptor.Descriptor(
  name='SoftmaxWithViewLossParameter',
  full_name='caffe.SoftmaxWithViewLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bandwidth', full_name='caffe.SoftmaxWithViewLossParameter.bandwidth', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='sigma', full_name='caffe.SoftmaxWithViewLossParameter.sigma', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='pos_weight', full_name='caffe.SoftmaxWithViewLossParameter.pos_weight', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='neg_weight', full_name='caffe.SoftmaxWithViewLossParameter.neg_weight', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='period', full_name='caffe.SoftmaxWithViewLossParameter.period', index=4,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=360,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SOFTMAXPOSNEGWITHLOSSPARAMETER = _descriptor.Descriptor(
  name='SoftmaxPosNegWithLossParameter',
  full_name='caffe.SoftmaxPosNegWithLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pos_weight', full_name='caffe.SoftmaxPosNegWithLossParameter.pos_weight', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='neg_weight', full_name='caffe.SoftmaxPosNegWithLossParameter.neg_weight', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ACCURACYVIEWPARAMETER = _descriptor.Descriptor(
  name='AccuracyViewParameter',
  full_name='caffe.AccuracyViewParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tol_angle', full_name='caffe.AccuracyViewParameter.tol_angle', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='period', full_name='caffe.AccuracyViewParameter.period', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=360,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['well_loss_param'].message_type = _WELLLOSSPARAMETER
_LAYERPARAMETER.fields_by_name['hadamard_product_param'].message_type = _HADAMARDPRODUCTPARAMETER
_LAYERPARAMETER.fields_by_name['subtraction_param'].message_type = _SUBTRACTIONPARAMETER
_LAYERPARAMETER.fields_by_name['l1_loss_param'].message_type = _L1LOSSPARAMETER
_LAYERPARAMETER.fields_by_name['periodic_loss_param'].message_type = _PERIODICLOSSPARAMETER
_LAYERPARAMETER.fields_by_name['quant_accuracy_param'].message_type = _QUANTACCURACYPARAMETER
_LAYERPARAMETER.fields_by_name['label_split_param'].message_type = _LABELSPLITPARAMETER
_LAYERPARAMETER.fields_by_name['mixed_pred_param'].message_type = _MIXEDPREDPARAMETER
_LAYERPARAMETER.fields_by_name['combine_loss_param'].message_type = _COMBINELOSSPARAMETER
_LAYERPARAMETER.fields_by_name['softmax_with_view_loss_param'].message_type = _SOFTMAXWITHVIEWLOSSPARAMETER
_LAYERPARAMETER.fields_by_name['softmax_pos_neg_loss_param'].message_type = _SOFTMAXPOSNEGWITHLOSSPARAMETER
_LAYERPARAMETER.fields_by_name['accuracy_view_param'].message_type = _ACCURACYVIEWPARAMETER
...
_HADAMARDPRODUCTPARAMETER.fields_by_name['weight_filler'].message_type = _FILLERPARAMETER
_COMBINELOSSPARAMETER.fields_by_name['norm'].enum_type = _COMBINELOSSPARAMETER_NORM
_COMBINELOSSPARAMETER_NORM.containing_type = _COMBINELOSSPARAMETER
...
DESCRIPTOR.message_types_by_name['WellLossParameter'] = _WELLLOSSPARAMETER
DESCRIPTOR.message_types_by_name['HadamardProductParameter'] = _HADAMARDPRODUCTPARAMETER
DESCRIPTOR.message_types_by_name['SubtractionParameter'] = _SUBTRACTIONPARAMETER
DESCRIPTOR.message_types_by_name['L1LossParameter'] = _L1LOSSPARAMETER
DESCRIPTOR.message_types_by_name['PeriodicLossParameter'] = _PERIODICLOSSPARAMETER
DESCRIPTOR.message_types_by_name['QuantAccuracyParameter'] = _QUANTACCURACYPARAMETER
DESCRIPTOR.message_types_by_name['LabelSplitParameter'] = _LABELSPLITPARAMETER
DESCRIPTOR.message_types_by_name['MixedPredParameter'] = _MIXEDPREDPARAMETER
DESCRIPTOR.message_types_by_name['CombineLossParameter'] = _COMBINELOSSPARAMETER
DESCRIPTOR.message_types_by_name['SoftmaxWithViewLossParameter'] = _SOFTMAXWITHVIEWLOSSPARAMETER
DESCRIPTOR.message_types_by_name['SoftmaxPosNegWithLossParameter'] = _SOFTMAXPOSNEGWITHLOSSPARAMETER
DESCRIPTOR.message_types_by_name['AccuracyViewParameter'] = _ACCURACYVIEWPARAMETER
...
WellLossParameter = _reflection.GeneratedProtocolMessageType('WellLossParameter', (_message.Message,), dict(
  DESCRIPTOR = _WELLLOSSPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.WellLossParameter)
  ))
_sym_db.RegisterMessage(WellLossParameter)

HadamardProductParameter = _reflection.GeneratedProtocolMessageType('HadamardProductParameter', (_message.Message,), dict(
  DESCRIPTOR = _HADAMARDPRODUCTPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.HadamardProductParameter)
  ))
_sym_db.RegisterMessage(HadamardProductParameter)

SubtractionParameter = _reflection.GeneratedProtocolMessageType('SubtractionParameter', (_message.Message,), dict(
  DESCRIPTOR = _SUBTRACTIONPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.SubtractionParameter)
  ))
_sym_db.RegisterMessage(SubtractionParameter)
...
PeriodicLossParameter = _reflection.GeneratedProtocolMessageType('PeriodicLossParameter', (_message.Message,), dict(
  DESCRIPTOR = _PERIODICLOSSPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.PeriodicLossParameter)
  ))
_sym_db.RegisterMessage(PeriodicLossParameter)

QuantAccuracyParameter = _reflection.GeneratedProtocolMessageType('QuantAccuracyParameter', (_message.Message,), dict(
  DESCRIPTOR = _QUANTACCURACYPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.QuantAccuracyParameter)
  ))
_sym_db.RegisterMessage(QuantAccuracyParameter)

LabelSplitParameter = _reflection.GeneratedProtocolMessageType('LabelSplitParameter', (_message.Message,), dict(
  DESCRIPTOR = _LABELSPLITPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.LabelSplitParameter)
  ))
_sym_db.RegisterMessage(LabelSplitParameter)

MixedPredParameter = _reflection.GeneratedProtocolMessageType('MixedPredParameter', (_message.Message,), dict(
  DESCRIPTOR = _MIXEDPREDPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.MixedPredParameter)
  ))
_sym_db.RegisterMessage(MixedPredParameter)

CombineLossParameter = _reflection.GeneratedProtocolMessageType('CombineLossParameter', (_message.Message,), dict(
  DESCRIPTOR = _COMBINELOSSPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.CombineLossParameter)
  ))
_sym_db.RegisterMessage(CombineLossParameter)

SoftmaxWithViewLossParameter = _reflection.GeneratedProtocolMessageType('SoftmaxWithViewLossParameter', (_message.Message,), dict(
  DESCRIPTOR = _SOFTMAXWITHVIEWLOSSPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.SoftmaxWithViewLossParameter)
  ))
_sym_db.RegisterMessage(SoftmaxWithViewLossParameter)

SoftmaxPosNegWithLossParameter = _reflection.GeneratedProtocolMessageType('SoftmaxPosNegWithLossParameter', (_message.Message,), dict(
  DESCRIPTOR = _SOFTMAXPOSNEGWITHLOSSPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.SoftmaxPosNegWithLossParameter)
  ))
_sym_db.RegisterMessage(SoftmaxPosNegWithLossParameter)

AccuracyViewParameter = _reflection.GeneratedProtocolMessageType('AccuracyViewParameter', (_message.Message,), dict(
  DESCRIPTOR = _ACCURACYVIEWPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.AccuracyViewParameter)
  ))
_sym_db.RegisterMessage(AccuracyViewParameter)
